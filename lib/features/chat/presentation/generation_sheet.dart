      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('这些参数会随当前会话保存，可在生成前快速调整。',
            ...
            DropdownButtonFormField<String>(
              ...
              onChanged: (value) => value == null
                  ? null
                  : _update(_settings.copyWith(model: value)),
            ),
            ...
            _SliderRow(
                ...
                max: 2,
                divisions: 20,
                display: _settings.temperature.toStringAsFixed(2),
                onChanged: (value) =>
                    _update(_settings.copyWith(temperature: value))),
            _SliderRow(
                label: 'Top P',
                ...
                max: 1,
                divisions: 20,
                display: _settings.topP.toStringAsFixed(2),
                onChanged: (value) => _update(_settings.copyWith(topP: value))),
            _SliderRow(
                label: '重复惩罚',
                ...
                max: 1.5,
                divisions: 10,
                display: _settings.repetitionPenalty.toStringAsFixed(2),
                onChanged: (value) =>
                    _update(_settings.copyWith(repetitionPenalty: value))),
            _SliderRow(
                label: '最大输出',
                ...
                max: 8192,
                divisions: 31,
                display: '${_settings.maxTokens} tokens',
                onChanged: (value) =>
                    _update(_settings.copyWith(maxTokens: value.round()))),
          ],
        ),
      ),
    );
          ...
          Row(children: [
            ...
            Text(display,
                style: const TextStyle(
                    color: SuicangTheme.primary, fontWeight: FontWeight.w700))
          ]),
          Slider(
              value: value,
              min: min,
