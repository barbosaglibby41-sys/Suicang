class PromptPreset {
  const PromptPreset({required this.name, this.model = '', this.temperature = .8, this.topP = .95, this.maxTokens = 2048, this.systemPrompt = '', this.source = '本地预设', this.extensions = const {}});
