...
final providerConfigProvider =
    NotifierProvider<ProviderConfigController, ProviderConfig>(
        ProviderConfigController.new);
...
class ProviderConfig {
  ...
  ProviderConfig copyWith(
          {String? baseUrl, String? model, String? apiKey, bool? enabled}) =>
      ProviderConfig(
...
class ProviderConfigController extends Notifier<ProviderConfig> {
  ...
  void setConnection(
      ...
      update(ProviderConfig(
          baseUrl: baseUrl, model: model, apiKey: apiKey, enabled: enabled));
